...
addEventHandler("onClientResourceStart", resourceRoot, function()
	...
	snow.wind_direction_image = guiCreateStaticImage(20,144,64,64,"snow/direction_image.png",false,snow.window)
	snow.wind_direction_pointer = guiCreateStaticImage(20,144,16,16,"snow/direction_pointer.png",false,snow.window)
	snow.wind_direction_pointer_middle = guiCreateStaticImage(44,168,16,16,"snow/direction_pointer.png",false,snow.window)
